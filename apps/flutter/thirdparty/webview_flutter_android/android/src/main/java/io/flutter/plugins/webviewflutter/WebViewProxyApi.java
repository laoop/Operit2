...
public class WebViewProxyApi extends PigeonApiWebView {
  ...
  /** Returns the current WebView page scale. */
  @Override
  public double getScale(@NonNull WebView pigeon_instance) {
    return pigeon_instance.getScale();
  }

  /** Scales the current WebView page viewport by a multiplicative factor. */
  @Override
  public void zoomBy(@NonNull WebView pigeon_instance, double zoomFactor) {
    pigeon_instance.zoomBy((float) zoomFactor);
  }
